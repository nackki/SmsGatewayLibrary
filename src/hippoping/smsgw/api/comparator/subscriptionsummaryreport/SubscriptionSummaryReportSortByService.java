 ...
 * @author developer
 */
public class SubscriptionSummaryReportSortByService implements Comparator<SummaryReport> {
    public int compare(SummaryReport s1, SummaryReport s2) {
        if (s1==null || s2==null) {
            return 0;
        }
        return s1.getServiceElement().srvc_name.compareTo(s2.getServiceElement().srvc_name);
    }
}
