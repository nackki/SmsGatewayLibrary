...
public class SubscriptionSummaryReportSortBySubBalanceTrueh
    ...
    public int compare(SummaryReport s1, SummaryReport s2) {
        ...
        return s1.getSub_balance(OperConfig.CARRIER.TRUEH) - s2.getSub_balance(OperConfig.CARRIER.TRUEH);
    }
}