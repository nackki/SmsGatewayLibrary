...
public class SubscriptionSummaryReportSortByUnsubTotalTrueh
    ...
    public int compare(SummaryReport s1, SummaryReport s2) {
        ...
        return s1.getUnsub_total(OperConfig.CARRIER.TRUEH) - s2.getUnsub_total(OperConfig.CARRIER.TRUEH);
    }
}