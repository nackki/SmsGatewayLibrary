 ...
 * @author developer
 */
public class SubscriptionSummaryReportSortByMtChrgTotalDtacSdp implements Comparator<SummaryReport> {
    public int compare(SummaryReport s1, SummaryReport s2) {
        if (s1==null || s2==null) {
            return 0;
        }
        return s1.getMt_chrg_total(CARRIER.DTAC_SDP) - s2.getMt_chrg_total(CARRIER.DTAC_SDP);
    }
}
