 ...
 * @author developer
 */
public class SubscriptionSummaryReportSortByUnsubRchgErrorDtac implements Comparator<SummaryReport> {
    public int compare(SummaryReport s1, SummaryReport s2) {
        if (s1==null || s2==null) {
            return 0;
        }
        return s1.getUnsub_rchg_error(CARRIER.DTAC) - s2.getUnsub_rchg_error(CARRIER.DTAC);
    }
}
