...
public class SubscriptionSummaryReportSortBySubErrorNoCreditTrueh
    ...
    public int compare(SummaryReport s1, SummaryReport s2) {
        ...
        return s1.getSub_error_nocredit(OperConfig.CARRIER.TRUEH) - s2.getSub_error_nocredit(OperConfig.CARRIER.TRUEH);
    }
}