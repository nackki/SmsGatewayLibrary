 ...
 * @author developer
 */
public class SubscriptionSummaryReportSortBySubTotalDtac implements Comparator<SummaryReport> {
    public int compare(SummaryReport s1, SummaryReport s2) {
        if (s1==null || s2==null) {
            return 0;
        }
        return s1.getSub_total(CARRIER.DTAC) - s2.getSub_total(CARRIER.DTAC);
    }
}
