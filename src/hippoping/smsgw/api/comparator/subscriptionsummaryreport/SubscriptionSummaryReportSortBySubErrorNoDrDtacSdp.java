 ...
 * @author developer
 */
public class SubscriptionSummaryReportSortBySubErrorNoDrDtacSdp implements Comparator<SummaryReport> {
    public int compare(SummaryReport s1, SummaryReport s2) {
        if (s1==null || s2==null) {
            return 0;
        }
        return s1.getSub_error_nodr(CARRIER.DTAC_SDP) - s2.getSub_error_nodr(CARRIER.DTAC_SDP);
    }
}
