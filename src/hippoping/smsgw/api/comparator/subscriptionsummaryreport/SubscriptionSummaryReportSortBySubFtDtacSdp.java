 ...
 * @author developer
 */
public class SubscriptionSummaryReportSortBySubFtDtacSdp implements Comparator<SummaryReport> {
    public int compare(SummaryReport s1, SummaryReport s2) {
        if (s1==null || s2==null) {
            return 0;
        }
        return s1.getSub_ft(CARRIER.DTAC_SDP) - s2.getSub_ft(CARRIER.DTAC_SDP);
    }
}
