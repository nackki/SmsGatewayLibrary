 ...
 * @author developer
 */
public class SubscriptionSummaryReportSortByUnsubReqTrue implements Comparator<SummaryReport> {
    public int compare(SummaryReport s1, SummaryReport s2) {
        if (s1==null || s2==null) {
            return 0;
        }
        return s1.getUnsub_req(CARRIER.TRUE) - s2.getUnsub_req(CARRIER.TRUE);
    }
}
