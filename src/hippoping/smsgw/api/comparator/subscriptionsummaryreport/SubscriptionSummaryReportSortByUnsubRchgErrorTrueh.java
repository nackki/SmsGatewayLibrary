...
public class SubscriptionSummaryReportSortByUnsubRchgErrorTrueh
    ...
    public int compare(SummaryReport s1, SummaryReport s2) {
        ...
        return s1.getUnsub_rchg_error(OperConfig.CARRIER.TRUEH) - s2.getUnsub_rchg_error(OperConfig.CARRIER.TRUEH);
    }
}