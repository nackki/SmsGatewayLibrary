 ...
 * @author developer
 */
public class SubscriptionSummaryReportSortBySubErrorNoCreditDtac implements Comparator<SummaryReport> {
    public int compare(SummaryReport s1, SummaryReport s2) {
        if (s1==null || s2==null) {
            return 0;
        }
        return s1.getSub_error_nocredit(CARRIER.DTAC) - s2.getSub_error_nocredit(CARRIER.DTAC);
    }
}
