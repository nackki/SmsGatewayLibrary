 ...
 * @author developer
 */
public class SubscriptionSummaryReportSortByMtChrgTotalTrue implements Comparator<SummaryReport> {
    public int compare(SummaryReport s1, SummaryReport s2) {
        if (s1==null || s2==null) {
            return 0;
        }
        return s1.getMt_chrg_total(CARRIER.TRUE) - s2.getMt_chrg_total(CARRIER.TRUE);
    }
}
