...
public class SubscriptionSummaryReportSortByMtChrgTotalTrueh
    ...
    public int compare(SummaryReport s1, SummaryReport s2) {
        ...
        return s1.getMt_chrg_total(OperConfig.CARRIER.TRUEH) - s2.getMt_chrg_total(OperConfig.CARRIER.TRUEH);
    }
}