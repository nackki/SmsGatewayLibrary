...
public class TruemoveSubscriptionService {
    ...
    public Response sendCss(int srvc_main_id, String msisdn, String keyword)
        ...
        try {
            hp.setUrl("http://truecssgateway:8080/smsgw-truemove-war/true/css3rdInterface");
    ...
    public RsrDetailElement sendRegister(ServiceElement se, String msisdn) throws Exception {
        ...
        String url = "http://smsgatewaydtac:8080/smsgw-truemove-war/true/mohandle";
