...
public class RsrReplyFactory
    ...
    public void write(String str) { System.out.println(RsrReplyFactory.class.getName() + ":" + str); }
    ...
    public void write(PrintWriter out) throws ServletException, IOException {
        try {
            ...
            com.truemove.css.mo.response.MessageElement rs = 
                    (com.truemove.css.mo.response.MessageElement) u.unmarshal(new StreamSource(new StringReader(xmlStr)));
